...
```bash
git clone https://github.com/SEU-USUARIO/biblioteca_2Mtec_2026_A.git
```
...
```bash
cd biblioteca_2Mtec_2026_A
git remote add upstream https://github.com/ensismoebius/biblioteca_2Mtec_2026_A.git
cd ..
```
